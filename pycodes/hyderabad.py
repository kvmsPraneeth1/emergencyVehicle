...
# sumo_tools_path = r'C:\newSumo\sumoNew'
net_file = r'C:\newSumo\project\projectA\simulations\sumoSimulation\output.net.xml'  # Replace with the path to your net.xml file
sumo_cfg_file = r'C:\newSumo\project\projectA\simulations\sumoSimulation\output.sumocfg'  # Replace with your SUMO config file
