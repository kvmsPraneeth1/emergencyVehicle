...
import traci
import threading
import tihan_traffic_controller as tc



# Path to SUMO tools and your net.xml file
# sumo_tools_path = r'C:\newSumo\sumoNew'
net_file = r'C:\newSumo\project\projectA\simulations\sumoSimulation2\tihan.net.xml'  # Replace with the path to your net.xml file
sumo_cfg_file = r'C:\newSumo\project\projectA\simulations\sumoSimulation2\tihan.sumocfg'  # Replace with your SUMO config file
